...
def question6() -> dict:
    ...
    answers["q6_1"] = {"equal_width": ["No Change", 7], "equal_freq": ["No change", 9]}
    answers["q6_2"] = {"equal_width": ["No Change", 7], "equal_freq": ["No change", 9]}
    answers["q6_3"] = {"equal_width": ["Change is", 2], "equal_freq": ["No change", 9]}
...
def question7() -> dict:
    ...
    answers["q7_3"] = [[0, 2], [3, 4], [5, 6], [7, 100]]
...
def question9() -> dict[str, Any]:
    ...
    answers["q9_3_explain"] = "Correlation coefficient is ideal for network traffic flows because it measures pattern similarity independent of magnitude, whereas Euclidean distance is sensitive to scale differences."
